...
describe('total likes', () => {
  ...
  test('of a blog with no likes property has 0 likes', () => {
...
describe('most blogs', () => {
  ...
  test('when list has many blogs is author of the most blogs', () => {
...
describe('most likes', () => {
  test('when list has only one blog is author and number of likes on that blog', () => {
  ...
  test('when list has many blogs is author with most number of likes', () => {
